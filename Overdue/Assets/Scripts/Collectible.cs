...
public class Collectible : MonoBehaviour
{
    public static string[] Lore = new string[] {
        ...
        "...citizens found themselves in the library by waking up between two shelves in a dizzy haze, unsure of how they got there, and then wandering around, trapped, until they wake with a start in their own beds, covered with sweat, and with a few books we checked out on [their] nightstand.",
